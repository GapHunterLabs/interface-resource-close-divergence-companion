package dev.gaphunter.interfaceresourceclosedivergencecompanion.review
...
object ReviewPrompt {
    ...
    private const val KEY_SEEN_FINDINGS = "dev.gaphunter.interfaceresourceclosedivergencecompanion.review.seenFindings"
    private const val KEY_ANSWERED = "dev.gaphunter.interfaceresourceclosedivergencecompanion.review.answered"

    private const val NOTIFICATION_GROUP_ID = "Interface Resource-Close Divergence Companion"

    // Marketplace listing (real ID resolved after first publish).
    private const val MARKETPLACE_URL = "https://plugins.jetbrains.com/plugin/34079-interface-resource-close-divergence-companion/reviews"
